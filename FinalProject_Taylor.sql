...
--Create Admiral Role
Create role admiral;
Revoke all on all tables in schema public from admirals;
Grant select on all tables in schema public to admirals;
Grant insert on beings, prisoners, crew, passengers, cargo, beingson, cargoon, affiliatedwith, locationof
To admiral;

--Create Captain Role		 
Create Role Captain;
 Revoke all on all tables in schema public from captain;
Grant select on beings, prisoners, crew, passengers, beingson, alliances, affiliatedwith, belongsto, cargo,cargoOn, locations, location of, systems, systemson, shipclass,classof
To captain;
